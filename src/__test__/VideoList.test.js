...
const translations = { en: { video_id: 'identifier', lataamo: 'Loader', videos: 'Videos', search: 'Search', video_title: 'Video title', video_duration: 'video duration', processing_state: 'processing_state' }, fi: { video_id: 'videon id', lataamo: 'Lataamo', videos: 'Videoni', search: 'Etsi', video_title: 'Videon nimi', video_duration: 'video duration', processing_state: 'processing_state' }, sv: { video_id: 'video id', lataamo: 'Loader', videos: 'Videor', search: 'Söka', video_title: 'Video titeln' , video_duration: 'video duration' , processing_state: 'processing_state' } };
