const translationsObject = {
    en: {
        ...
        archived_date : 'Vanhenemis- päivä',
        ...
        public_series: 'Public. The recordings in the series may appear in public listing on the university’s website and in search engine results.	',
        unlisted_series: 'Shared with a link. The recordings in the series can be shared and embedded elsewhere using links. Anyone who receives such a link can view the recording. Recordings or links to the them do not appear on the university web site or public search engines.',
        unpublished_series: 'Non-public. The recordings in the series are visible only to its administrators and in the Moodle course areas you select.',
        ...
        public_series : 'Julkinen. Sarjan tallenteet voivat näkyä yliopiston verkkosivujen julkisessa listauksessa ja hakukoneiden tuloksissa.',
        unlisted_series: 'Jaettu linkillä. Sarjan tallenteita voi jakaa ja upottaa minne vain linkkien avulla. Kuka tahansa tällaisen linkin saava voi katsoa tallenteen. Sarjan tallenteet tai linkit niihin eivät näy yliopiston verkkosivujen tai julkisten hakukoneiden listauksissa.',
        unpublished_series: 'Ei-julkinen. Sarjan tallenteet ovat näkyvissä vain sen hallinnoijille ja valitsemillasi Moodle-alueilla.',
    ...
    sv: {
        ...
        public_series : 'Offentlig. Inspelningar i serien kan visas på universitetets webbplats och i sökmotorernas resultat.',
        unlisted_series: 'Delas via länk. Inspelningarna i serien kan delas och bäddas in på andra ställen med hjälp av länkar. Alla som får en sådan länk kan se inspelningen. Inspelningar eller länkar till dem visas inte på universitetets webbplats eller offentliga sökmotorer.',
        unpublished_series: 'Inte publicerat. Inspelningarna i serien är endast synliga för dess administratörer och för de Moodle-områden du väljer.',
