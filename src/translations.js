const translationsObject = {
    en: {
        ...
        series_editing_rights_info: 'You can provide administrator rights to the series for university staff and students and different user groups by using the search fields. The persons and groups with the rights will have equal rights to modify and delete the recordings.',
        series_included_videos: 'Recordings included in a series',
        add_person: 'Select the administrator (type at least four characters in the search field to begin the search)',
    ...
    sv: {
        ...
        add_person: 'Välj administratör (skriv minst fyra tecken i sökfältet för att starta sökningen)',
