const translationsObject = {
    en: {
        ...
        series_visibility_info_old: 'Lisää rasti ruutuun, jos haluat jakaa ja julkaista sarjan tallenteineen laajemman yleisön nähtäville Unitube-katsomossa. Sinun pitää julkaista sarja Unitube-katsomossa myös silloin, jos haluat upottaa sen videoita katsottavaksi esim. muille sivuille tai kursseille. Huomaathan, että sinulla tulee olla tallenteilla esiintyvien suostumus julkaisuun.',
        ...
        video_views: 'Tallenteen katselukerrat',
    ...
    sv: {
        ...
        series_visibility_info: 'Välj om du vill dela och publicera serien inklusive inspelningar via länk eller för en bredare publik i Unitube. Observera att du ska ha samtycke från dem som figurerar i inspelningen för att kunna publicera den!',
