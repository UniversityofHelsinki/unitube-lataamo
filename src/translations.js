const translationsObject = {
    en: {
        ...
        search_events: 'Etsi tallennetta/tallenteita',
        ...
        video_file_info: 'Klikkaa Browse-painiketta ja etsi avautuvasta ikkunasta koneeltasi tai laitteeltasi tallenne, jonka haluat ladata palveluun. Tuettuja tiedostomuotoja ovat (ainakin) .avi, .mov, .mp4 ja muut yleisimmät videotiedostot.',
        ...
        CC_BY_NC_ND: '???CC-BY-NC-ND???',
        CC0: '???CC0???',
        ALLRIGHTS_long_info: 'ALLRIGHTS on plaa plaa',
        CC_BY_long_info: 'CC_BY on plaaplaa',
        ...
        CC_BY_NC_ND_long_info: 'CC_BY_NC_ND on plaaplaaplaaplaaa',
        CC0_long_info: 'CC0 on plaapka',
        licence_link_text: 'Hei, haluatko lukea lisää lisensseistä?',
        licence_link: 'https://creativecommons.fi/',
        ...
        succeeded_to_delete_event: 'Tallenteen poistaminen onnistui. Voit vielä palauttaa sen yms. jne.',
        trash: 'Poistamani tallenteet',
        trash_info: 'Poistamasi tallenteet näkyvät täällä x ajan. Voit vielä palauttaa ne valitsemalla nnn',
